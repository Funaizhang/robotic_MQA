...
def test(rank):
    ...
    while(action_times < max_action):
        ...
        position_in,planner_img_feats_var = data2input(position,rgb_before_resize,cnn)

        output_data, planner_hidden = act_model.planner_step(encoded_question,planner_img_feats_var,action_in,position_in,planner_hidden)
